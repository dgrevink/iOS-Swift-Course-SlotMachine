...
//  SlotMachine
//
//  Created by David Grevink on 2014-11-14.
...
class ViewController: UIViewController {
    ...
    func setupFourthContainer(containerView: UIView) {
        ...
        self.resetButton.setTitle("Reset", forState: UIControlState.Normal) // different button for another state .Normal, .Selected, etc...
